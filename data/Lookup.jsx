...
export default {
  ...
  SIGNIN_HEADING: 'Continue With COSpaceAI 1.0',
  SIGNIN_SUBHEADING: 'To use COSpaceAI you must log into an existing account or create one.',
  SIGNIn_AGREEMENT_TEXT: 'By using COSpaceAI, you agree to the collection of usage data for analytics.',
...
`
  ...
  PRICING_OPTIONS:[
    ...
    },
    {
      ...
      tokens:'120K',
      value:120000,
      desc:'Designed for professionals who need to use COSpaceAI a few times per week.',
      price:9.99
    },
    {
      name:'Pro',
